			...
			?>
				<div class="col-sm-12">
					...
					if ( ! empty( $custom_blog_archive_title ) && is_home() ) {
                        ...
                        if ((strpos(get_the_archive_title(), 'Archives:') !== false)) {
                            $archive_title = substr(get_the_archive_title(), 10);
                        }
                        if((strpos(get_the_archive_title(), 'Arhive:') !== false)){
                            $archive_title = substr(get_the_archive_title(), 8);
                        }
						else {
